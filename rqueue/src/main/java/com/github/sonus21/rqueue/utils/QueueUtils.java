...
public class QueueUtils {
  ...
  private static final String QUEUE_META_DATA_PREFIX = "__rq::q-mdata::";
  ...
  public static String getMetaDataKey(String queueName) {
    return QUEUE_META_DATA_PREFIX + queueName;
  }
