...
public class RqueueMessageTemplateTest {
  static {
    System.setProperty("TEST_NAME", RqueueMessageTemplateTest.class.getSimpleName());
  }
  ...
  public void moveMessageZsetToList() throws TimedOutException {
    ...
    for (int i = 0; i < 10; i++) {
      Notification notification = Notification.newInstance();
      messageSender.enqueueWithDelay(queue, notification, 50000L);
    }
  ...
  public void moveMessageZsetToZset() throws TimedOutException {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      messageSender.enqueueWithDelay(jobQueueName, job, 50000L);
    }
